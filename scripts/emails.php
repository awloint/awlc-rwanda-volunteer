...
<tr>
<td style='padding-right: 40px; text-align: right;' colspan='2'><span style='font-size: 12pt; font-family: Helvetica;'>30th January, 2019</span></td>
</tr>
<tr>
...
<strong>Skills to Volunteer: </strong> {$skills} <br>
...
<strong>Reason for Volunteering: </strong> {$reasonForVolunteering} <br>
<strong>Can they work remotely?: </strong> {$canWorkRemotely} <br>
<strong>Do they live in Rwanda?: </strong> {$livesInRwanda} <br>
<strong>How many hours per week are they available?: </strong> {$availableTime} <br>
<strong>Their preferred Communication Channel: </strong> {$communicationChannel} <br>
</p>
<p>Warm Regards,</p>
<p><img src='https://stbensonimoh.com/email/sign_rosette_blue_ink.png' height='50px' /></p>
</td>
